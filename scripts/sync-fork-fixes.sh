...
SOURCE_SPECS=(
  ...
  "redo|https://github.com/Kotatsu-Redo/Kotatsu-Redo.git|devel|upstream"
  "futon|https://github.com/AppFuton/Futon.git|devel|upstream"
)
...
[[ -n "${REPO_ROOT}" ]] || die "Run this script from inside the Kaisoku repository."
cd "${REPO_ROOT}"
